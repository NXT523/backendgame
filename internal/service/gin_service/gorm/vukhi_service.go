...
type vuKhiServiceGorm struct {
	repo repository_Gorm.VuKhiRepoGorm
}

func NewVuKhiServiceGorm(repo repository_Gorm.VuKhiRepoGorm) *vuKhiServiceGorm {
	return &vuKhiServiceGorm{
		repo: repo,
	}
}

func (s *vuKhiServiceGorm) CreateGorm(ctx context.Context, vk *models.VuKhis) (*models.VuKhis, error) {
	return s.repo.CreateGorm(ctx, vk)
}

func (s *vuKhiServiceGorm) GetAllGorm(ctx context.Context, kw string) ([]*models.VuKhis, error) {
	return s.repo.GetAllGorm(ctx, kw)
}

func (s *vuKhiServiceGorm) UpdateByNameGorm(ctx context.Context, name string, vk models.VuKhiUpdateInput) (*models.VuKhis, error) {
	return s.repo.UpdateByNameGorm(ctx, name, vk)
}
...
func (s *vuKhiServiceGorm) SearchGorm(
	ctx context.Context,
